...
export default async function handler(req, res) {
  ...
  try {
    const itens = prepararLote(numerosDaPlanilha(lerPlanilhaXlsx(await lerBody(req))));
    ...
    if (["lote_invalido", "lote_vazio", "lote_maior_que_500", "xlsx_invalido", "arquivo_maior_que_2mb"].includes(codigo)) return erro(res, 400, codigo);
